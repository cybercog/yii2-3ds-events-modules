...
class Module extends \yii\base\Module
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'yii3ds\events\controllers\frontend';
     ...
     */
    public $previewPath = '@statics/web/events/previews/';

    /**
     * @var string Image path
     */
    public $imagePath = '@statics/web/events/images/';

    /**
     * @var string Files path
     */
    public $filePath = '@statics/web/events/files';

    /**
     * @var string Files path
     */
    public $contentPath = '@statics/web/events/content';

    /**
     * @var string Images temporary path
     */
    public $imagesTempPath = '@statics/temp/events/images/';

    /**
     * @var string Preview URL
     */
    public $previewUrl = '/statics/events/previews';

    /**
     * @var string Image URL
     */
    public $imageUrl = '/statics/events/images';

    /**
     * @var string Files URL
     */
    public $fileUrl = '/statics/events/files';

    /**
     * @var string Files URL
     */
    public $contentUrl = '/statics/events/content';
    ...
    public function init()
    {
        ...
        if ($this->getIsBackend() === true) {
            $this->setViewPath('@yii3ds/events/views/backend');
        } else {
            $this->setViewPath('@yii3ds/events/views/frontend');
        }
    }
